...
| --- | --- | --- |
| `AlertAppearance.CLASSIC` | ![Classic alert appearance](docs/alert-appearance-classic.svg) | The existing default style with a flat background and visible border. |
| `AlertAppearance.GRADIENT` | ![Gradient alert appearance](docs/alert-appearance-gradient.svg) | A softer gradient style with a stronger icon badge. |
